    ...
    <html lang="ru">
      ...
      <body className={`${manrope.variable} ${cormorant.variable} antialiased`}>
        ...
        <Script id="metrika" strategy="afterInteractive">{`
          ...
          ym(108980267,'init',{webvisor:true,clickmap:true,accurateTrackBounce:true,trackLinks:true});
        `}</Script>
        <noscript><img src="https://mc.yandex.ru/watch/108980267" style={{position:'absolute',left:'-9999px'}} alt="" /></noscript>
      </body>
    </html>
  );
}
