        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-text-muted leading-relaxed mb-10">
              <p>
                Телеведущая, продюсер, создатель авторских проектов — более
                15 лет на федеральных и тематических ТВ-каналах. Автор и
                ведущая реалити-шоу «OK Upgrade» на канале MusicBox Russia
                и серии подкастов «Разговор на ОК» на Первом Национальном
                Телеканале.
              </p>
              <p>
                Коммерческий директор MMA-TV.com, спикер деловых форумов,
                основатель собственной премии и организатор спецпроектов
                в медиасфере. Главный принцип — жёсткая дисциплина и
                результат, который виден всем.
              </p>
              <p>
                Ок Про Продакшн — это её команда, которая делает с вашим
                брендом то же самое, что Олеся сделала со своим: выводит
                на новый уровень узнаваемости без шаблонов и пустых обещаний.
              </p>
            </div>
